    ...
    methods: {
        ...
        checkUserLogin(recall) {
            if (this.getCookie("UserId") != "" && this.getCookie("UserAuth") != "") {
                ...
                xml.onload = function() {
                    ...
                    if (jsonResponse["SteamId"] != undefined) {
        ...
        loadRecommended() {
            ...
            xml.onload = function() {
                ...
                let cover = self.coverRightNow.Path
                if (cover.includes("webm")) {
                    self.coverRightNow.isVideo = true
                    self.coverRightNow.Path = cover
                } else {
                    self.coverRightNow.isVideo = false
                    self.coverRightNow.Path = cover
                }
                setTimeout(function() {
                    self.loadImages()
        ...
        getCookie(cname) {
          ...
          loadImages() {
            let listToLoad = document.getElementsByClassName("toLoad")
            for (element in listToLoad) {
                let elem = listToLoad[element]
